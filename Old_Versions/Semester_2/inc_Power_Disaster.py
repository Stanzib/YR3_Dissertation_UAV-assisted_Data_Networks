...
print("script started: Increasing host Power transmit, Disaster Scenario - Central BS Non-Operational")
...
for i in range(1, Iteration_range + 1):
    ...
    print(f"Starting UAV count: {P_tx_Host}")
...
def print_results():
    ...
    fig.suptitle('Disaster Scenario — UAV Relay Performance vs Host Transmit Power\n'
                 '(Central BS Non-Operational; Host Served by Nearest Neighbour BS)',
                 fontsize=13)

    axes[0, 0].plot(power_values, SINR_list,     'b-o', markersize=3, label='General')
    axes[0, 0].plot(power_values, SINR_list_wor, 'r--', markersize=3, label='Worst')
    axes[0, 0].plot(power_values, SINR_list_bes, 'g--', markersize=3, label='Best')
    ...
    axes[0, 1].plot(power_values, Capacity_list,     'b-o', markersize=3, label='General')
    axes[0, 1].plot(power_values, Capacity_list_wor, 'r--', markersize=3, label='Worst')
    axes[0, 1].plot(power_values, Capacity_list_bes, 'g--', markersize=3, label='Best')
    ...
    axes[0, 2].plot(power_values, Outage_list,     'b-o', markersize=3, label='General')
    axes[0, 2].plot(power_values, Outage_list_wor, 'r--', markersize=3, label='Worst')
    axes[0, 2].plot(power_values, Outage_list_bes, 'g--', markersize=3, label='Best')
    ...
    axes[1, 0].semilogy(power_values, BER_list,     'b-o', markersize=3, label='General')
    axes[1, 0].semilogy(power_values, BER_list_wor, 'r--', markersize=3, label='Worst')
    axes[1, 0].semilogy(power_values, BER_list_bes, 'g--', markersize=3, label='Best')
    ...
    axes[1, 1].plot(power_values, Energy_Eff_list,     'b-o', markersize=3, label='General')
    axes[1, 1].plot(power_values, Energy_Eff_list_wor, 'r--', markersize=3, label='Worst')
    axes[1, 1].plot(power_values, Energy_Eff_list_bes, 'g--', markersize=3, label='Best')
    ...
    axes[1, 2].plot(power_values, SINR_list_baseline, 'y-o', markersize=3, label='Baseline (no UAV)')
...
baseline_average = sinr_baseline_total / (num_iterations * Iteration_range)
