...
print ("start script: Increaseing Power, Urban model")
# ------- Models Map ----------------------------------------
...
power_increment = max_power_host / power_range_total


# -------- Each UAV -----------------------------------------
for i in range(1, power_range_total + 1):
    ...
    #want power to be wetween 0 and 5 with power_range_total iterations
